          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: const Icon(Icons.check_rounded, size: 36, color: Colors.teal),
              ),
              ...
              Text(
                ...
                style: TextStyle(fontSize: 14.5, height: 1.4, color: Colors.grey.shade700),
              ),
        ...
        children: [
          Container(
            ...
            child: TextField(
              ...
              inputFormatters: const [DecimalTextInputFormatter(decimalRange: 2)],
              decoration: const InputDecoration(
                hintText: "e.g. SR 50.00",
                border: InputBorder.none,
                prefixIcon: Icon(Icons.shopping_bag_outlined, color: hassalaGreen1),
              ),
            ),
          ),
          const SizedBox(height: 20),
          ...
          Container(
            ...
            child: TextField(
              ...
              decoration: const InputDecoration(
                ...
                border: InputBorder.none,
                prefixIcon: Icon(Icons.chat_bubble_outline, color: hassalaGreen1),
              ),
            ),
          ),
      ...
      return Center(
        child: Column(
          ...
          children: const [
            ...
            SizedBox(height: 16),
            Text("No requests yet", style: TextStyle(fontSize: 16, color: Colors.grey)),
          ],
        ),
      );
    }
