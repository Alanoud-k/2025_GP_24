  ...
  Future<void> _confirmDeleteChore(String choreId) async {
    ...
    if (confirm == true) {
      try {
        ...
        _refreshData(); // ✅ تحديث بيانات الطفل بعد الحذف
        _showMessageBar(
              ...
              if (imageUrl.isNotEmpty)
                ClipRRect(
                  ...
                  child: Image.network(
                    ...
                    height: 250, // طول ثابت
                    width: double
                        .infinity, // الآن هذا سيعمل لأن الأب (SizedBox) له عرض محدد
                    fit: BoxFit.cover,
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    isActive
                        ? (isSubmitted ? "Waiting Review" : chore.status)
                        : "Completed",
                    style: TextStyle(
                      fontSize: 12,
