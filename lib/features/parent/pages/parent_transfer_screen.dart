...
//   // ✅ Used to dynamically calculate and show amounts based on slider
...
//                     textAlign: TextAlign.center,
//                     onChanged: (_) {
//                       // Trigger rebuild to update calculated split amounts
//                       setState(() {});
//                     },
//                     style: const TextStyle(
//                       fontSize: 32,
...
import 'dart:convert';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart'; // 👈 استيراد مكتبة الـ formatters
import 'package:http/http.dart' as http;
import 'package:shared_preferences/shared_preferences.dart';
import 'package:my_app/utils/check_auth.dart';
import 'package:my_app/core/api_config.dart';
              ...
              child: Stack(
                ...
                children: [
                  TextField(
                    ...
                    // 👇 إضافة inputFormatters لتحويل الأرقام العربية إلى إنجليزية والسماح بالنقطة العشرية
                    inputFormatters: [
