  ...
  Future<void> _fetchChildren() async {
    ...
    if (token == null) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(l10n.authErrorMissingToken)),
      );
      return;
    }
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          _kids = data.map((child) {
            return {
              "id": child["childId"],
              "name": child["firstName"] ?? l10n.unnamedChild,
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              l10n.failedToLoadChildrenCode(response.statusCode.toString()),
            ),
          ),
        );
      }
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text(l10n.errorFetchingChildrenEx(e.toString()))));
    }
  }
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return GestureDetector(
                            onTap: () {
                              final childBalance = (kid["balance"] is num)
