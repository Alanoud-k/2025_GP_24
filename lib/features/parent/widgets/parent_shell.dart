...
class _ParentShellState extends State<ParentShell> {
  ...
  // 🎯 تعريف مفاتيح شريط التنقل السفلي بشكل صريح لربطها بالجولة
  final GlobalKey _choresKey = GlobalKey();
  ...
  Widget build(BuildContext context) {
    ...
    final pages = [
      ParentHomeScreen(
        parentId: parentId, 
        token: token,
        // 👈 تمرير المفاتيح كمتغيرات اختيارية صريحة لمنع أخطاء الـ Map
        choresKey: _choresKey,
