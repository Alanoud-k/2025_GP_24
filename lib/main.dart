...
import 'package:my_app/core/providers/locale_provider.dart'; // 👈 مسار الملف الجديد
// Auth / Onboarding
import 'package:my_app/features/auth/pages/mobile_input_screen.dart';
import 'package:my_app/features/auth/pages/opening.dart';
...
void main() async {
  ...
  // ✅ تغليف التطبيق بـ MultiProvider لتهيئة LocaleProvider
  runApp(
    MultiProvider(
      providers: [
...
class MyApp extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // ✅ الاستماع لتغييرات اللغة من الـ Provider
    ...
    return MaterialApp(
      ...
      // ✅ ربط لغة التطبيق بالـ Provider لكي تتغير فوراً في كل الشاشات
